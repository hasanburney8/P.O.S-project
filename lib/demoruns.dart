...
class rregisterScreen extends StatefulWidget {
  const rregisterScreen({super.key});

  @override
  State<rregisterScreen> createState() => _registerScreenState();
}

class _registerScreenState extends State<rregisterScreen> {
